...
public class Values {
	...
	static final int STATES_NUMBER = 8;
	...
	static final int RUNNINGS = 50;
	static final double DEFAULT_MUTATION_PROB = 0.1;
	static final double[] MUTATION_PROBABILITIES = new double[] { 0.1 };
